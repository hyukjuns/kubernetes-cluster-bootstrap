...
1. Container Runtime 설치 - containerd
    ...
    [containerd install docs](https://github.com/containerd/containerd/blob/main/docs/getting-started.md#getting-started-with-containerd)

    사전설정: iptables 세팅 (Forwarding IPv4 and letting iptables see bridged traffic)
